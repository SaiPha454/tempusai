...
export async function deleteExamScheduleProgram(snapshotId: string, programValue: string): Promise<void> {
  await apiClient.delete(`${examBasePath}/schedules/${snapshotId}/programs/${encodeURIComponent(programValue)}`);
}
